    ...
    $.fn.extend({
        gallery: function(options) {
            ...
            return this.each(function() {
                ...
                var isLoaded = false;
                ///*'fadein' 'blind' 'appear' 'fillin' 'explode' 'jumble' 'paint' 'diagonal' 'crunchingbars' 'slidein' 'fallingbars' 'risingbars'
                var animationList = ['fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein', 'fadein'];
